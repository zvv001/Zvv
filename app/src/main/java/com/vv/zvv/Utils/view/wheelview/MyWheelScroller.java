...
public class MyWheelScroller {
    ...
    /**
     * Minimum delta for scrolling // 最小加速度，下文中当做最小距离使用-vv
     */
    ...
    private boolean isScrollingPerformed;//滚动是否执行
     ...
     */
    public MyWheelScroller(Context context, ScrollingListener listener) {
    ...
    private Handler animationHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            int delta = lastScrollY - currY;//改成：distance更好-vv
            lastScrollY = currY;
            if (delta != 0) {
