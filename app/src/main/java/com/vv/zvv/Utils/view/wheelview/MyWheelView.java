package com.vv.zvv.Utils.view.wheelview;
...
public class MyWheelView extends View {
    ...
    private boolean isScrollingPerformed;//是否滚动中
    ...
    private List<MyOnWheelChangedListener> changingListeners = new LinkedList<>();
    private List<MyOnWheelScrollListener> scrollingListeners = new LinkedList<>();
    private List<MyOnWheelClickedListener> clickingListeners = new LinkedList<>();
    ...
    protected void notifyScrollingListenersAboutStart() {
        for (MyOnWheelScrollListener listener : scrollingListeners) {//加强版 for循环
